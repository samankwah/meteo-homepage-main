...
const AgroMetAdvisory = () => {
  ...
  const languageInfo = {
    ...
    ak: { name: "Twi", code: "twi_Latn", translateFrom: true },
    dag: { name: "Dagbani", code: "dag_Latn", translateFrom: true },
    ee: { name: "Ewe", code: "ewe_Latn", translateFrom: true },
    ha: { name: "Hausa", code: "hau_Latn", translateFrom: true },
    // Add more languages as needed based on GhanaNLP's supported languages
    dga: { name: "Dagaare", code: "dga_Latn", translateFrom: true },
    kpo: { name: "Ikposo", code: "kpo_Latn", translateFrom: true },
    gur: { name: "Farefare", code: "gur_Latn", translateFrom: true },
  };
    ...
    const checkApiAvailability = async () => {
      try {
        const response = await fetch(
          "https://translation-api.ghananlp.org/health",
          {
            method: "GET",
            headers: {
  ...
  const handleTextToSpeech = async () => {
    ...
    if (isOfflineMode) {
      ...
      switch (selectedLanguage) {
        case "en":
          ...
          break;
        case "ak":
          utterance.lang = "ak"; // If browser supports Akan
          break;
        case "ee":
        ...
        case "dag":
          ...
          break;
        case "ha":
          utterance.lang = "ha"; // If browser supports Hausa
          break;
        default:
          utterance.lang = "en-GB";
      }
    ...
    try {
      ...
      const speaker = languageSpeakers[selectedLanguage]?.[0] || "eng_male_1";
