...
//           <Dropdown links={gmetLinks} title="CLIENTELE" />
//         </div>
//         <Link
//           to="/admin-login"
...
//                 {/* Expandable Clientele Section */}
//                 <div>
//                   <button
//                     className={`flex items-center justify-between w-full px-6 py-3 text-gray-950 hover:bg-gray-100 ${
//                       expandedSection === "clientele" ? "bg-blue-50" : ""
//                     }`}
//                     onClick={() => toggleSection("clientele")}
//                     aria-expanded={expandedSection === "clientele"}
//                   >
//                     <div className="flex items-center">
//                       <FaExternalLinkAlt className="mr-4 text-lg" />
