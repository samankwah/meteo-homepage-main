...
const Dropdown = ({ links, title }) => {
  ...
  return (
    ...
    >
      ...
      {isDropdownOpen && (
        <div
          className="absolute left-0 z-10 w-52 bg-white border border-gray-200 rounded-md shadow-lg"
          style={{ top: "100%" }}
        >
          <ul className="py-1">
            {links.map((link) => (
  ...
  return (
    ...
    >
      <div className="container mx-auto flex items-center justify-between px-2 md:px-4">
        ...
        {/* Desktop Navbar Links */}
        <div
          className={`hidden text-black lg:flex align-middle items-center justify-center flex-1 space-x-4 xl:space-x-6`}
        >
          <Link
            to="/"
            className={`block px-3 font-semibold text-sm border-b-2 ${
      ...
      {isMobileMenuOpen && (
        ...
        >
          <nav className="flex flex-col text-left space-y-3 py-2">
            <Link
              to="/"
              className="block px-4 py-2 text-black font-semibold hover:bg-gray-200 rounded-md transition duration-200 text-sm"
              onClick={() => setIsMobileMenuOpen(false)}
            >
              <FaHome className="inline mr-2 text-black" /> Home
            </Link>
            <Link
              to="/market-page"
              className="block px-4 py-2 text-black font-semibold hover:bg-gray-200 rounded-md transition duration-200 text-sm"
              onClick={() => setIsMobileMenuOpen(false)}
            >
              <FaShoppingCart className="inline mr-2 text-black" /> Market
            </Link>
            ...
            <Link
              ...
              onClick={() => setIsMobileMenuOpen(false)}
            >
              <FaComments className="inline mr-2 text-black" /> Agromet Advisory
            </Link>
            ...
            <Link
              ...
              onClick={() => setIsMobileMenuOpen(false)}
            >
              <FaImage className="inline mr-2 text-black" /> Media
            </Link>

            {/* Mobile Dropdown for Weather */}
            <div>
              <button
                className="block w-full px-4 py-2 text-black font-semibold hover:bg-gray-200 rounded-md transition duration-200 text-left text-sm"
                onClick={() =>
                  setOpenDropdown(
                    openDropdown === "forecast" ? null : "forecast"
                  )
              ...
              >
                <FaCloudSun className="inline mr-2 text-black" /> Weather{" "}
                <FaChevronDown className="inline ml-1 text-black" />
              </button>
              {openDropdown === "forecast" && (
                <div className="pl-6 py-1 ml-2 border-l-2 border-gray-200">
                  {forecastLinks.map((link) => (
                    <Link
                      key={link.to}
                      to={link.to}
                      className="block px-4 py-2 text-black hover:bg-gray-200 rounded-md transition duration-200 text-sm"
                      onClick={() => {
                        setIsMobileMenuOpen(false);
                        setOpenDropdown(null);
                      }}
            ...
            <div>
              ...
              >
                <FaSeedling className="inline mr-2 text-black" /> Agriculture{" "}
                <FaChevronDown className="inline ml-1 text-black" />
              </button>
              {openDropdown === "agriculture" && (
                <div className="pl-6 py-1 ml-2 border-l-2 border-gray-200">
            ...
            <div>
              ...
              >
                Clientele <FaChevronDown className="inline ml-1 text-black" />
              </button>
              {openDropdown === "gmet" && (
                <div className="pl-6 py-1 ml-2 border-l-2 border-gray-200">
                  {gmetLinks.map((link) => (
            ...
            >
              <FaUser className="inline mr-2 text-black" /> Admin
            </Link>
          </nav>
        </div>
      )}
